...
slug: toggle-switch
description: iOS-style toggle switch with smooth animations, async support, and full accessibility
category: ui-component
tags: [toggle, switch, checkbox, settings, accessible, animated]
features: [iOS-Style Design, Async Support, Size Variants, Icon Support, Color Themes, State Labels, Group Behavior, Accessibility, Loading States, Feedback]
