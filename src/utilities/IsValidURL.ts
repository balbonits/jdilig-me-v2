...
export const metadata: UtilityMetadata = {
  ...
  detailedDescription: "🌐 **The URL Validation Guardian**\nURL validation ensures links, API endpoints, and web resources are properly formatted and accessible! Essential for form validation, link checking, and preventing malformed URL errors.\n\n🧠 **The URL Challenge:**\n• **Format Verification:** Ensure proper protocol, domain, and path structure\n• **Protocol Support:** Handle HTTP, HTTPS, FTP, and other URL schemes\n• **Domain Validation:** Verify domain format and TLD requirements\n• **Special Characters:** Handle encoded characters and international domains\n\n⚡ **Multiple Validation Strategies:**\n• **Native URL API:** Use browser/Node.js built-in URL constructor\n• **RegEx Patterns:** Custom regular expressions for specific requirements\n• **Hybrid Approach:** Combine native API with additional checks\n\n🚀 **Real-World Applications:**\n• **Form Validation:** Validate website URLs in contact forms\n• **Link Checking:** Verify external links in content management\n• **API Endpoints:** Validate service URLs in configuration\n• **Social Media:** Validate profile and website links\n• **SEO Tools:** Check URL structure for search optimization\n• **Security:** Prevent URL injection and malformed redirects\n\n💡 **Learning Value:**\n• URL structure and web standards understanding\n• Native browser APIs vs custom validation approaches\n• Regular expression patterns for complex string matching\n• Input sanitization and security considerations",
  category: "Validation",
  concepts: ["URL parsing", "regular expressions", "web standards", "input validation"],
