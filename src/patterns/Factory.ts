...
export const metadata: PatternMetadata = {
  ...
  concepts: ["object creation", "polymorphism", "abstraction", "decoupling"],
  timeComplexity: "O(1) - constant time creation",
  spaceComplexity: "O(1) - per created object",
  difficulty: "Easy",
  category: "Creational",
  useCases: ["Object Creation", "API Design", "Code Organization"],
  realWorldApplications: [
    "React component libraries (Material-UI, Ant Design)",
    "Database ORM connection adapters",
    "Payment processing systems",
    "Cloud service provider abstractions",
    "Plugin architectures and middleware",
